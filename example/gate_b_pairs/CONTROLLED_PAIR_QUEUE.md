...
| ~~7~~ | PNE02 | — | LOOP target | — | **waived** — baseline2 LOOP UI only allows goto step 1 |
| 8 | PNE02 | `0x00010003/612` | Sampling interval | 1 s → 2 s | `record_time_s@340` |
| ~~9~~ | PNE16 | — | Charge current | — | **waived** — shared-prefix `current_mA@16`; see PNE02 `pne02-charge-current/` + `pne02-discharge-current/` |
| ~~10~~ | PNE16 | — | Rest duration | — | **waived** — shared-prefix `time_or_rest_s@20`; see PNE02 `pne02-rest-duration/` |
