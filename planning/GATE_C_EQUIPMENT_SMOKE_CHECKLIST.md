...
| 스텝 | 종류 | 확인 항목 | 기대값 |
|------|------|-----------|--------|
| 공통 | 시험/공통 안전조건 | 용량 (0/.000 이면 안 됨) | **800** (또는 **0.800 Ah**) — 셀 80 mAh의 안전 상한(10×) |
| 공통 | 시험/공통 안전조건 | Vmax / Vmin / 온도 | 4.200 V / 2.500 V / 70 |
| 공통 | 시험/공통 안전조건 | 최대 전류 | **0.800 A** (800 mA) 근처 — `.000`이면 안 됨 |
...
| 공통 안전조건 용량이 표시된다 (0 아님) | ☐ | 기대: ~800 mAh / 0.800 Ah (Ensol `0x3D8+16`) |
